    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-300">
                Please enter the backup verification code
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" action="{{ route('2fa.backup.post') }}" method="POST">
            @csrf
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    <label for="code" class="sr-only">Backup Code</label>
        ...
        <div class="text-sm text-center">
            <a href="{{ route('2fa.verify') }}" class="text-indigo-400 hover:text-indigo-300">
                Did you find your authenticator app?
            </a>
        </div>
